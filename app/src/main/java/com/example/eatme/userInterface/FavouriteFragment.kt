...
class FavouriteFragment : Fragment(), CoroutineScope {
    ...
    private lateinit var restaurantAdapter: FavouriteAdapter
    ...
    override fun onCreateView(
        ...
        viewModel.getRestaurantsForFavourite()

        // set up the RecyclerView
        recyclerView = root.findViewById(R.id.my_recycler_view_favourite)
        restaurantAdapter = FavouriteAdapter()
